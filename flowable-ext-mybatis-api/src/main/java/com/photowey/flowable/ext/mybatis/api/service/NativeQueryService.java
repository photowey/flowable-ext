 ...
 *
 * Tnless required by applicable law or agreed to in writing, software
 * distributed under the License is distributed on an "AS IS" BASIS,
 * WITHOTT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
...
public interface NativeQueryService {
    ...
    NativeQueryExt createNativeQuery();

    long count(NativeQueryAdaptor query);

    Map<String, Object> singleResult(NativeQueryAdaptor query);

    List<Map<String, Object>> list(NativeQueryAdaptor query);

    List<Map<String, Object>> listPage(NativeQueryAdaptor query);
